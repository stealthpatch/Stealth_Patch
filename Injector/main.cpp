...
//
// COMMAND LINE: stealth_patch DLL EXE ARGUMENTS
//
...
void FixCommandLine(int argc, char* argv[])
{
	...
	{
		StrDel(g_CommandLine, (char*)"+set fs_game raw", '\0');

		if (StrDel(g_CommandLine, (char*)"+set fs_game dev ", '\0'))
...
int main(int argc, char* argv[])
{
	...
	if (argc < 3)
	{
		OnErrorOccurred("USAGE: stealth_patch.exe <DLL> <EXE> <ARGUMENTS>\n");
		return 0;
	}
