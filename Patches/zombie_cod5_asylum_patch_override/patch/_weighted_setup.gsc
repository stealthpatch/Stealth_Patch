...
init()
{
    ...
    weighted_setup_scenarios = array( 
        array( "ray_gun_zm", "zombie_cymbal_monkey", "rpk_zm", "cz75dw_zm" ), // ray, monkeys, rpk and dual czs
        array( "ray_gun_zm", "zombie_cymbal_monkey", "hk21_zm", "knife_ballistic_zm" ) // ray, monkeys, hk21 and bknives
    );
